...
public class MapaBibliotecaMeco implements MapaBiblioteca {
	...
	public MapaBibliotecaMeco (final List<Puerta> puertas) {
		...
		estanciasEnZona[Zona.TRES.ordinal()][Zona.DOS.ordinal()] = new EstanciaEnZona(Zona.DOS, puertas.get(0), new IntervaloEstancia(5, 15), new Probabilidad(0, 100));
		...
		estanciasEnZona[Zona.CUATRO.ordinal()][Zona.DOS.ordinal()] = new EstanciaEnZona(Zona.DOS, puertas.get(0), new IntervaloEstancia(5, 15), new Probabilidad(0, 100));
		...
		estanciasEnZona[Zona.CINCO.ordinal()][Zona.DOS.ordinal()] = new EstanciaEnZona(Zona.DOS, puertas.get(0), new IntervaloEstancia(5, 15), new Probabilidad(0, 100));
